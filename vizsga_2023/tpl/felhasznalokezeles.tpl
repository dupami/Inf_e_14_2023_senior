...
<head>
    ...
    <title>Felhasználó létrehozás</title>
</head>

<body>
    <a href="logout.php" class="btn btn-outline-danger">Logout</a><br>

    <form method="POST" action="letrehoz.php">
        <div class="card">
            <div class="mb-3">
            ...
            <button type="submit" name="letrehoz" class="btn btn-success">Létrehoz</button>
        </div>
    </form>
